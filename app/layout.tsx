...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      ...
      <body
        className={`${syne.variable} ${hankenGrotesk.variable} ${jetBrainsMono.variable} bg-background text-on-background antialiased selection:bg-primary selection:text-on-primary`}
      >
        {children}
      </body>
    </html>
